...
public class SetGesturePoint {
	...
	public void setPointState(int state) {
		pointState = state;
		switch (state) {
		case SetGestureConstants.POINT_STATE_NORMAL:
			this.image.setBackgroundResource(R.drawable.sign_gray);
			break;
		case SetGestureConstants.POINT_STATE_SELECTED:
			this.image.setBackgroundResource(R.drawable.sign_blue);
			break;
		case SetGestureConstants.POINT_STATE_WRONG:
			this.image.setBackgroundResource(R.drawable.sign_red);
			break;
		default:
			break;
		}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SetGesturePoint other = (SetGesturePoint) obj;
